...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "SIG Foncier Maritime — Alertes et litiges fonciers" },
      {
        name: "description",
        content:
          "Plateforme Web-GIS de centralisation des parcelles, plaintes, litiges et alertes foncières de la région Maritime du Sud-Togo.",
      },
